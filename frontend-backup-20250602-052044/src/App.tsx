...
// Placeholder components for legacy mode
const MamaBearControlCenter = () => <div>MamaBear Control Center - Legacy Mode</div>;
const UnifiedDevelopmentHub = () => <div>Unified Development Hub - Legacy Mode</div>;
const ScoutDynamicWorkspace = () => <div>Scout Dynamic Workspace - Legacy Mode</div>;
const MiniAppLauncher = () => <div>Mini App Launcher - Legacy Mode</div>;
const DesignSystemProvider = ({ children }: { children: React.ReactNode }) => <>{children}</>;
