...
import { X, Plus, Search, Grid3X3, Settings, ExternalLink, Maximize2, Minimize2, RotateCcw } from 'lucide-react';
...
const ScoutMiniAppsHub = () => {
  ...
  // Your custom miniapps list (matching your requirements)
  const miniApps = [
    { id: 'chatgpt', name: 'ChatGPT', icon: '🤖', url: 'https://chat.openai.com', category: 'AI Chat' },
    { id: 'gemini', name: 'Gemini', icon: '💎', url: 'https://gemini.google.com', category: 'AI Chat' },
    ...
    { id: 'jules', name: 'Jules', icon: '💫', url: 'https://jules.google.com', category: 'Google AI' },
